...
# Use parent project folder for shared DB and source files (no copy per subfolder)
_script_dir = Path(__file__).resolve().parent
_project_root = _script_dir.parent
DATA_PATH = _project_root / "4e_database_files"
OUTPUT_DB = str(_project_root / "4e_compendium.db")
